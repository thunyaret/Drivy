        ...
        Form(
            Div(
                ...
                Div(
                    ...
                    Input(type="date", id="start_date", name="start_date", required=True, style="padding: 8px; border-radius: 8px; border: 1px solid #90caf9; width: 100%;")
                ),
                Div(
                    Label("End Date", style="color: #0d47a1; font-size: 18px; font-weight: bold;"),
                    Input(type="date", id="end_date", name="end_date", required=True, style="padding: 8px; border-radius: 8px; border: 1px solid #90caf9; width: 100%;")
                ),
...
def rate_car(reservation_id: str, rating: float, comment: str):
    ...
    return Container(
         Style("body { font-family: Arial; background: #f8f8f8; padding: 20px; }"),
         H1("Reservation to rate not found")
    )
