# รถ -----------------------------------------------------------------------
class Car:
    def __init__(self, id, model, licensecar, price, status, color):
        self.__id = id
        self.__model = model
...
user1 = User(3001, "user1", "pass1", "user", "U-111")
...
def init_data():
    ...
    if not company.get_cars():
        ...
        # เพิ่มผู้ใช้งานลงใน Company
        company.add_user(user1)
        company.add_driver(driver1)
        company.add_user(admin1)

        # สร้าง instance ของรถ
        car1 = Car("1", "Toyota", "D0-1125", 2000, "available", "red")
        ...
        # สร้างรถเพิ่มอีกคัน
        car2 = Car("2", "Honda", "D0-1126", 2500, "available", "blue")
